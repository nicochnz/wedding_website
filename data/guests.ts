...
export const guests: Guest[] = [
  ...
  { slug: "patou", name: "Patou", house: "Gîte nature & détente", houseNumber: 3, mapPosition: { x: 75, y: 40 }, note: "Chambre 2" },
  { slug: "jackie", name: "Jackie", house: "Gîte nature & détente", houseNumber: 3, mapPosition: { x: 75, y: 40 }, note: "Chambre 2" },
  ...
  { slug: "maude", name: "Maude", house: "Gîte nature & détente", houseNumber: 3, mapPosition: { x: 75, y: 40 }, note: "Chambre 1" },
  { slug: "alex", name: "Alex", house: "Gîte nature & détente", houseNumber: 3, mapPosition: { x: 75, y: 40 }, note: "Chambre 1" },
